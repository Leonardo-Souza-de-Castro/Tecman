...
import { LerConteudo } from "../../services/ocr";
...
export const Patrimonio = () => {
    ...
    const Cadastrar = (event) => {
      ...
      formData.append('imagem', imagem); //método append responsavel por adicionar os valores como chave e valor
    ...
    const LerOCR = (event) => {
      ...
      let resultado_OCR = LerConteudo(formData)
